        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="flex items-center mb-4">
              <Users className="h-8 w-8 text-cyan-400 mr-4" />
              <h3 className="font-minecraft text-2xl text-cyan-400">GLOBAL REACH</h3>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="bg-black/50 p-2 border border-cyan-400/20 rounded-md">
                <div className="font-minecraft text-cyan-400 text-xl">1000+</div>
                <div className="text-xs text-white/70">Daily Players</div>
              </div>
              <div className="bg-black/50 p-2 border border-cyan-400/20 rounded-md">
                <div className="font-minecraft text-cyan-400 text-xl">50+</div>
                <div className="text-xs text-white/70">Countries</div>
              </div>
              <div className="bg-black/50 p-2 border border-cyan-400/20 rounded-md">
                <div className="font-minecraft text-cyan-400 text-xl">5</div>
          ...
          >
            <div className="flex items-center mb-4">
              <Trophy className="h-8 w-8 text-cyan-400 mr-4" />
              <h3 className="font-minecraft text-2xl text-cyan-400">GUILDS & PARTIES</h3>
            </div>
            <p className="text-white/80 mb-6">
            ...
            <div className="bg-black/50 p-4 border border-cyan-400/20 rounded-md">
              ...
              <div className="flex justify-between items-center mb-2">
                <span className="text-white/80">Diamond Miners</span>
                <span className="font-minecraft text-yellow-400">1250 $FARM</span>
              </div>
              <div className="flex justify-between items-center mb-2">
                <span className="text-white/80">Emerald Knights</span>
                <span className="font-minecraft text-yellow-400">980 $FARM</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-white/80">Redstone Wizards</span>
                <span className="font-minecraft text-yellow-400">840 $FARM</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center mb-4">
              <CalendarDays className="h-8 w-8 text-cyan-400 mr-4" />
              <h3 className="font-minecraft text-2xl text-cyan-400">LIMITED EVENTS</h3>
            </div>
            <p className="text-white/80 mb-6">
          ...
          >
            <div className="flex items-center mb-4">
              <MessageSquare className="h-8 w-8 text-cyan-400 mr-4" />
              <h3 className="font-minecraft text-2xl text-cyan-400">JOIN OUR CHANNELS</h3>
            </div>
            <p className="text-white/80 mb-6">
